...
import { changePortalPassword, type PasswordState } from "./actions";

const EMPTY: PasswordState = {};

export function PasswordForm({ forced }: { forced: boolean }) {
  const [state, action, pending] = useActionState(changePortalPassword, EMPTY);
  ...
  return (
    <form action={action} className="flex flex-col gap-4">
      ...
      <Field
        ...
        help="At least 10 characters, with a letter and a digit."
      />
      <Field
        name="confirm"
