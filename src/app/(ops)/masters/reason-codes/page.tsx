...
const FIELDS: FieldDef[] = [
  ...
  { type: "switch", name: "isChargeable", label: "Chargeable to the customer", defaultOn: false },
  { type: "switch", name: "notifiesConsignor", label: "Notify consignor", defaultOn: false },
  { type: "switch", name: "notifiesConsignee", label: "Notify consignee", defaultOn: false },
  {
    type: "switch",
    name: "requiresPhoto",
  ...
  { type: "switch", name: "requiresRemarks", label: "Remarks mandatory", defaultOn: false },
