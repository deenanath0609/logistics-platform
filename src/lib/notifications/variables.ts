...
export const SHIPMENT_VARIABLES: VariableSpec[] = [
  { name: "lrNumber", description: "Consignment note number", sample: "CL/DEL/2627/000412" },
  { name: "trackingUrl", description: "Public tracking link for this LR", sample: "https://track.example/CL-000412" },
...
export const EVENT_VARIABLES: VariableSpec[] = [
  ...
  { name: "otpCode", description: "One-time code the consignee reads out at the door", sample: "4821", events: ["notification.delivery_otp"] },
